...
struct PodcastList: Hashable {
  ...
  Podcast(podcastName: "1", authorName: "Marco", podcastType: "Life & Chill", episodeQty: "46 Eps"),
  Podcast(podcastName: "2", authorName: "Marco", podcastType: "Life & Chill", episodeQty: "46 Eps")
  ]
}
